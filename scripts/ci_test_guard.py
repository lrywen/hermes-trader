...
#
# W7 收尾（2026-09-21）上抬至实测值 4629：回测内核 guard 增 B-guard 两守——
# 杠杆一致性 assert_leverage_allowed(LIVE_LEVERAGE=10) + 逐币成本表齐全度
...
# 4603 → 4604。
# Audit 2026-09-22 (#backtest)：backtest_short_regime 重写为统一内核，新增
# variant 准入 + 扫描/内核连线测试 +2，4604 → 4606。
MIN_OFFLINE_TESTS = 4606
